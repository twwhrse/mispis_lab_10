...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        var department = new Department("09.03.02", courses);
        ...
        var project = new Project("Умная система питания для домашних питомцев", new Date(123456789), new Date(999999999));

        var assistant = new ResearchAssociate("Максимов","Программирование");

        var admin = new AdministrativeEmployee("Гамидов");
